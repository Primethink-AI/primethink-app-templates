...
- **Base**: Core assistant functionality — always on, required for all tasks
...
1. Define your objective and choose a task pattern
2. Write the Goal (the AI's instruction set) and Initial Prompt
3. Configure capabilities and attach collections if needed
